...
DRAWER_BOTTOM_KNOB = [0.155, -0.26, 0.28, 90, 0, 0]
DRAWER_TOP_KNOB = [0.155, -0.26, 0.54, 90, 0, 0]
DRAWER_LEFT_KNOB = [0.52, -0.26, 0.275, 90, 0, 0]
...
TRAY_A = [0.60, 180, 0, 90]
TRAY_B = [0.60, 180, 0, 90]

BIN_A = [0.55, 180, 0, 90]
BIN_B = [0.55, 180, 0, 90]


EEF_POINT_DOWN_FLOOR_Z_MIN = 0.09
EEF_POINT_DOWN_LONG_TABLE_B_Z_MIN = (0.09 + 0.40)
EEF_POINT_DOWN_TALL_TABLE_Z_MIN = (0.09 + 0.60)
